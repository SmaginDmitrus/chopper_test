...
bool cond_down(double x,double y,double z){
        return(z>=0.81 && z<= (0.81+ cond_length ) && y>=-0.07 && y<=0.07 && x>=-(cond_width/2.0) && x <= -(cond_width/2.0 - 0.005));
    }
bool cond_up(double x,double y,double z){
        return(z>=0.81 && z<=(0.81 + cond_length ) && y>=-0.07 && y<=0.07 && x >= (cond_width/2.0)-0.005 && x<=(cond_width/2.0));
    }
bool cyl_2(double x,double y,double z){
        return (x*x + y*y >= (0.065)*(0.065) && z >= (0.82+cond_length) && z<=(1.15));
    }
bool cyl_3(double x,double y,double z){
        return (x*x + y*y >= (0.04)*(0.04) && z >= 1.15 && z<=1.2);
    }
